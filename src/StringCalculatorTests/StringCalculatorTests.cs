...
public class StringCalculatorTests
{
    ...
    public void Add_MultipleNumbers_ReturnsSum(string numbers, int expected)
    {
        var calculator = new StringCalculator();
    ...
    [Fact]
    public void Add_MultipleCharCustomDelimiter_ReturnsSum()
    {
        var calculator = new StringCalculator();

        var numbers = $"//[***]{Environment.NewLine}1***2***3";
        var expected = 6;
    ...
    [Fact]
    public void Add_CustomDelimiters_ReturnsSum()
    {
        var calculator = new StringCalculator();
